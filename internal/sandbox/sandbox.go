...
func (s *Sandbox) Run(ctx context.Context) (Report, error) {
	...
	container, err := libcontainer.Create(s.runtimeCfg.LibcontainerDir, s.id, libcontainerConfig)
	if err != nil {
...
func (s *Sandbox) Destroy() error {
	...
	if err := os.RemoveAll(filepath.Join(s.runtimeCfg.OverlayFSDir, fmt.Sprintf("sandbox-%s", s.id))); err != nil {
